...
import { UserResponse } from '../Dto/User/UserReponse';
import { UserService } from '../_services/user.service';
import { UserParams } from '../_helpers/userParams';
import { PaginatedParams } from '../_helpers/paginatedParams';
import { ActivatedRoute, Router } from '@angular/router';
import { UserDeepLinkingService } from '../_services/user-deep-linking.service';
import { NavigationService } from '../_services/navigation.service';

@Component({
  selector: 'app-admins',
  templateUrl: './admins.component.html',
  styleUrls: ['./admins.component.scss', '../comment/comment.component.scss']
})
export class AdminsComponent implements OnInit {
  ...
  constructor(private userService: UserService, private route: ActivatedRoute, private router: Router, private navigationService: NavigationService) { }
